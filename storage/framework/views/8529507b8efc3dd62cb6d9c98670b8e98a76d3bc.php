            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if(Auth::check()): ?>                        
                        ...
                        <?php if((Auth::user()->rol->nomRol) == "Enfermera"): ?>
                        ...
                        <?php else: ?>                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3">
                                    <div class="card-footer px-3 py-2">
                                        <a class="btn-block text-muted d-flex justify-content-between" href="/empresa/empleados"><span class="font-weight-bold">Ver Empleados</span>
                                            <svg class="c-icon">
                                                <use xlink:href="<?php echo e(asset('assets/dashboard/vendors/@coreui/icons/svg/free.svg#cil-chevron-right')); ?>"></use>
                                            </svg>
                                        </a>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3">
                                    <div class="card-footer px-3 py-2">
                                        <a class="btn-block text-muted d-flex justify-content-between" href="/empresa/pacientes">
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3">
                                    <div class="card-footer px-3 py-2">
                                        <a class="btn-block text-muted d-flex justify-content-between" href="/empresa/usuarios">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\sismped\sispmed\resources\views/home.blade.php ENDPATH**/ ?>