...
<?php $__env->startSection("contenido"); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="/empresa/pacientes/guardar" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-12">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-3">  
                        ...
                        <div class="form-check form-check-inline">                                
                            ...
                            <label class="form-check-label" for="exampleCheck1">Indefinido</label>
                        </div>                                                    
                    </div>
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <div class="form-group">
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\sismped\sispmed\resources\views/empresa/pacientes/create.blade.php ENDPATH**/ ?>