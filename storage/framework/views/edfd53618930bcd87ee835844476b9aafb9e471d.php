...
<?php echo $__env->make('flash::message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="row">
        ...
        <div class="col-sm-5 col-md-6 col-lg-6">
            <a href="/empresa/pacientes/crear">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body" style="padding-bottom: 5px;">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="/empresa/pacientes/view/<?php echo e($paciente->id); ?>">
                                ...
                                <div class="text-xs font-weight-bold mb-1">
                                    <?php echo e($paciente->tipoId_id); ?> - <?php echo e($paciente->nIdPac); ?> / <?php echo e($paciente->fecNac->age); ?> <?php echo app('translator')->get('años'); ?>
                                </div>
                                <div class="text-xs font-weight-bold mb-1">
                    ...
                    <center>
                    <div>
                        <a href="/empresa/pacientes/view/<?php echo e($paciente->id); ?>" class="btn btn-xs btn-info" title="Ver Información"><i class="fa fa-eye"></i> </a>
                        <a href="/empresa/pacientes/editar/<?php echo e($paciente->id); ?>" class="btn btn-xs btn-warning" title="Editar"><i class="fa fa-pen"></i> </a>
                        <?php if($paciente->estado == "Activo"): ?>
                            <a href="/pacientes/cambiarestado/<?php echo e($paciente->id); ?>/0" class="btn btn-xs btn-danger" title="Inactivar"><i class="fa fa-times"></i> </a>
                        <?php else: ?>
                        <a href="/pacientes/cambiarestado/<?php echo e($paciente->id); ?>/1" class="btn btn-xs btn-success"><i class="fa fa-check" title="Activar"></i> </a>
                        <?php endif; ?>                        
                    </div>
                    </center>
                </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\sismped\sispmed\resources\views/empresa/pacientes/index.blade.php ENDPATH**/ ?>