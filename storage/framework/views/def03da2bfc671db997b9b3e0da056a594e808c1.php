...
<?php $__env->startSection("contenido"); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="/empresa/pacientes/acompanantes/actualizar" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="tipoId" id="tipoId">
                                <?php $__currentLoopData = $tiposId; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tipo->id); ?>" 
                                        <?php if($tipo->id == $acompanante->tipoId_id): ?>    
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\sismped\sispmed\resources\views/empresa/pacientes/acompanantes/edit.blade.php ENDPATH**/ ?>