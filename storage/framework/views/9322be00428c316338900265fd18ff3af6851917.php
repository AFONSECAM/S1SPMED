            ...
            <div class="row" id="identificacion">
                <div class="col-6">                
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="txtFecha" name="txtFecha" value="<?php echo e($citas->fecha->format('Y-m-d')); ?>">
                    </div>                
                </div>
                <div class="col-6">                
                    <div class="form-group">
                        <label for="txtHora">Hora</label>
                        <input type="time" class="form-control" id="txtHora" name="txtHora" aria-describedby="emailHelp" value="<?php echo e($citas->hora_inicio->toTimeString()); ?>">
                    </div>                
                </div>
                <div class="col-3">                
                    <div class="form-group">
