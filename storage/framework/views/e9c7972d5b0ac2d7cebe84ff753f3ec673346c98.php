...
<?php $__env->startSection("contenido"); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="/empresa/pacientes/acompanantes/guardar" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="paciente" value="<?php echo e($pacienteId); ?>"/>
                <div class="row">
                    <div class="col-12">
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\andre\Desktop\sismped\sispmed\resources\views/empresa/pacientes/acompanantes/create.blade.php ENDPATH**/ ?>